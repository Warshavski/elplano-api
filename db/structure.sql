...
CREATE TABLE public.students (
    ...
    about text,
    social_networks jsonb DEFAULT '{}'::jsonb NOT NULL,
    president boolean DEFAULT false NOT NULL,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    group_id bigint
);
...
--
-- Name: index_groups_on_president_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_groups_on_president_id ON public.groups USING btree (president_id);
...
ALTER TABLE ONLY public.events
    ADD CONSTRAINT fk_rails_15c34a9137 FOREIGN KEY (creator_id) REFERENCES public.students(id);
...
--
-- Name: fk_rails_548a5da065; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.groups
    ADD CONSTRAINT fk_rails_548a5da065 FOREIGN KEY (president_id) REFERENCES public.students(id);
...
--
-- Name: fk_rails_92bb7a13fa; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT fk_rails_92bb7a13fa FOREIGN KEY (group_id) REFERENCES public.groups(id);
