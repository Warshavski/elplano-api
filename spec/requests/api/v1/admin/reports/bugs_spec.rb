...
RSpec.describe Api::V1::Admin::Reports::BugsController, type: :request do
  ...
  describe 'GET #index' do
    ...
    context 'when user is authorized user' do
      it 'expected to respond with reports collection' do
  ...
  describe 'DELETE #destroy' do
    ...
    it 'is expected to respond with a 404 status not existed bug report' do
      delete "#{base}/0", headers: headers

      expect(response).to have_http_status(:not_found)
    end

    it 'is expected to delete bug report' do
